...
Individual.setRefModel(RefModel('../inputs/Model_SinusCardinal2D.txt'))
# Error and Post-Processing
Individual.setErrorMethod("mse")
Individual.setPostProcessing("scalling")

outputList = 'progress info-operator info-pygenalg dot current info-generation info-improvement pareto-history convergence end-sigma'
outputList = 'info-generation progress end-pareto end-convergence'
